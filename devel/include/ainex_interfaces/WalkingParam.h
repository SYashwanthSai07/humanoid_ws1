// Generated by gencpp from file ainex_interfaces/WalkingParam.msg
// DO NOT EDIT!


#ifndef AINEX_INTERFACES_MESSAGE_WALKINGPARAM_H
#define AINEX_INTERFACES_MESSAGE_WALKINGPARAM_H
...
struct WalkingParam_
{
  ...
  _step_fb_ratio_type step_fb_ratio;
   ...
   typedef uint32_t _period_times_type;
  _period_times_type period_times;
  ...
  typedef boost::shared_ptr< ::ainex_interfaces::WalkingParam_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ainex_interfaces::WalkingParam_<ContainerAllocator> const> ConstPtr;

}; // struct WalkingParam_

typedef ::ainex_interfaces::WalkingParam_<std::allocator<void> > WalkingParam;

typedef boost::shared_ptr< ::ainex_interfaces::WalkingParam > WalkingParamPtr;
typedef boost::shared_ptr< ::ainex_interfaces::WalkingParam const> WalkingParamConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ainex_interfaces::WalkingParam_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ainex_interfaces::WalkingParam_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::ainex_interfaces::WalkingParam_<ContainerAllocator1> & lhs, const ::ainex_interfaces::WalkingParam_<ContainerAllocator2> & rhs)
{
  return lhs.init_x_offset == rhs.init_x_offset &&
    ...
    lhs.period_times == rhs.period_times &&
...
template <class ContainerAllocator>
struct IsFixedSize< ::ainex_interfaces::WalkingParam_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ainex_interfaces::WalkingParam_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ainex_interfaces::WalkingParam_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ainex_interfaces::WalkingParam_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ainex_interfaces::WalkingParam_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ainex_interfaces::WalkingParam_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ainex_interfaces::WalkingParam_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ainex_interfaces::WalkingParam_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x33a0fc392acf75f9ULL;
  static const uint64_t static_value2 = 0xca94c3da5d14814aULL;
};

template<class ContainerAllocator>
struct DataType< ::ainex_interfaces::WalkingParam_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ainex_interfaces::WalkingParam_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ainex_interfaces::WalkingParam_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ainex_interfaces::WalkingParam_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ainex_interfaces::WalkingParam_<ContainerAllocator>& v)
  {
    ...
    s << indent << "period_times: ";
    Printer<uint32_t>::stream(s, indent + "  ", v.period_times);
...
#endif // AINEX_INTERFACES_MESSAGE_WALKINGPARAM_H
