...
class WalkingParam {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('period_times')) {
        this.period_times = initObj.period_times
      }
      else {
        this.period_times = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [period_times]
    bufferOffset = _serializer.uint32(obj.period_times, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [period_times]
    data.period_times = _deserializer.uint32(buffer, bufferOffset);
  ...
  static datatype() {
    ...
    return 'ainex_interfaces/WalkingParam';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '33a0fc392acf75f9ca94c3da5d14814a';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.period_times !== undefined) {
      resolved.period_times = msg.period_times;
    }
    else {
      resolved.period_times = 0
    }
