...
(cl:defclass <ObjectsInfo> (roslisp-msg-protocol:ros-message)
  ((data
    :reader data
    :initarg :data
    :type (cl:vector ainex_interfaces-msg:ObjectInfo)
   :initform (cl:make-array 0 :element-type 'ainex_interfaces-msg:ObjectInfo :initial-element (cl:make-instance 'ainex_interfaces-msg:ObjectInfo))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ObjectsInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectsInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ainex_interfaces-msg:<ObjectsInfo> is deprecated: use ainex_interfaces-msg:ObjectsInfo instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ObjectsInfo>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'data)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ainex_interfaces-msg:ObjectInfo))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ObjectsInfo>)))
  ...
  "d2fb73326b72ae8d2e6610c8589c196f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ObjectsInfo)))
  "Returns md5sum for a message object of type 'ObjectsInfo"
  "d2fb73326b72ae8d2e6610c8589c196f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ObjectsInfo>)))
  ...
  (cl:format cl:nil " ainex_interfaces/ObjectInfo[] data~%~%================================================================================~%MSG: ainex_interfaces/ObjectInfo~%string label~%string type~%int32 width~%int32 height~%int32 x~%int32 y~%int32 radius~%int32 angle~%int32[] left_point~%int32[] right_point~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ObjectsInfo)))
  "Returns full string definition for message of type 'ObjectsInfo"
  (cl:format cl:nil " ainex_interfaces/ObjectInfo[] data~%~%================================================================================~%MSG: ainex_interfaces/ObjectInfo~%string label~%string type~%int32 width~%int32 height~%int32 x~%int32 y~%int32 radius~%int32 angle~%int32[] left_point~%int32[] right_point~%~%~%"))
