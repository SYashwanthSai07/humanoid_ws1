...
(cl:defmethod cl:initialize-instance :after ((m <ButtonState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ButtonState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_robot_controller-msg:<ButtonState> is deprecated: use ros_robot_controller-msg:ButtonState instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <ButtonState>))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ButtonState>)))
  ...
  (cl:format cl:nil "uint8 id~%uint8 state~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ButtonState)))
  "Returns full string definition for message of type 'ButtonState"
  (cl:format cl:nil "uint8 id~%uint8 state~%~%~%"))
