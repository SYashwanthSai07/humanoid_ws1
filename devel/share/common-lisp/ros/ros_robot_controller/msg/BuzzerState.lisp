...
(cl:defmethod cl:initialize-instance :after ((m <BuzzerState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BuzzerState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_robot_controller-msg:<BuzzerState> is deprecated: use ros_robot_controller-msg:BuzzerState instead.")))

(cl:ensure-generic-function 'freq-val :lambda-list '(m))
(cl:defmethod freq-val ((m <BuzzerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_robot_controller-msg:freq-val is deprecated.  Use ros_robot_controller-msg:freq instead.")
  (freq m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BuzzerState>)))
  ...
  "ros_robot_controller/BuzzerState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BuzzerState)))
  "Returns string type for a message object of type 'BuzzerState"
  "ros_robot_controller/BuzzerState")
