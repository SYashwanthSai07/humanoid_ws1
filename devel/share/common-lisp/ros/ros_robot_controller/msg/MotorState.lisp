...
(cl:defmethod cl:initialize-instance :after ((m <MotorState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_robot_controller-msg:<MotorState> is deprecated: use ros_robot_controller-msg:MotorState instead.")))
...
(cl:defmethod rps-val ((m <MotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_robot_controller-msg:rps-val is deprecated.  Use ros_robot_controller-msg:rps instead.")
  (rps m))

(cl:ensure-generic-function 'duty-val :lambda-list '(m))
(cl:defmethod duty-val ((m <MotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_robot_controller-msg:duty-val is deprecated.  Use ros_robot_controller-msg:duty instead.")
  (duty m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MotorState>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'rps))))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MotorState>) istream)
  "Deserializes a message object of type '<MotorState>"
    ...
    (cl:setf (cl:slot-value msg 'rps) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MotorState>)))
  ...
  (cl:format cl:nil "uint16 id~%float64 rps~%int8 duty~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MotorState)))
  "Returns full string definition for message of type 'MotorState"
  (cl:format cl:nil "uint16 id~%float64 rps~%int8 duty~%~%~%"))
