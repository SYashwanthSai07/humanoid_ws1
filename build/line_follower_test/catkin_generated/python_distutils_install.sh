...
echo_and_run cd "/home/niat/humanoid_ws/src/line_follower_test"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/niat/humanoid_ws/src/line_follower_test/setup.py" \
     \
    build --build-base "/home/niat/humanoid_ws/build/line_follower_test" \
    install \
    --root="${DESTDIR-/}" \
