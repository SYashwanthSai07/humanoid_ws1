...
echo_and_run cd "/home/niat/humanoid_ws/src/ainex_driver/ainex_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/niat/humanoid_ws/src/ainex_driver/ainex_kinematics/setup.py" \
     \
    build --build-base "/home/niat/humanoid_ws/build/ainex_driver/ainex_kinematics" \
    install \
    --root="${DESTDIR-/}" \
