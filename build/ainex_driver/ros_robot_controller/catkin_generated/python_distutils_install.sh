...
echo_and_run cd "/home/niat/humanoid_ws/src/ainex_driver/ros_robot_controller"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/niat/humanoid_ws/src/ainex_driver/ros_robot_controller/setup.py" \
     \
    build --build-base "/home/niat/humanoid_ws/build/ainex_driver/ros_robot_controller" \
    install \
    --root="${DESTDIR-/}" \
