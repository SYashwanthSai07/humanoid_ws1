...
class Controller:
    ...
    def __init__(self, name):
        ...
        if self.gazebo_sim:
            self.walking_param = common.get_yaml_data('/home/niat/humanoid_ws/src/ainex_driver/ainex_kinematics/config/walking_param_sim.yaml')
        else:
            self.walking_param = common.get_yaml_data('/home/niat/humanoid_ws/src/ainex_driver/ainex_kinematics/config/walking_param.yaml')
